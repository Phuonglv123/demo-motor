...
class FooterScene1 extends Component {
    render() {
        return (
            <div className='m-4 p-4'>
                ...
                <div>
                    ...
                    <div>
                        <span>a)  Toàn bộ nội dung của trang web nhattrungtech.com.vn được bảo vệ bởi bản quyền (Bảo lưu mọi quyền).</span>
                    </div>
                    <div>
                        <span>b)  Các danh mục, bài báo cũng như các thành phần của website nhattrungtech.com.vn có thể được tải về, sao chép hoặc in ra với điều kiện ghi nguồn nhattrungtech.com.vn hoặc đính kèm logo của nhattrungtech.com.vn (việc sử dụng logo nhattrungtech.com.vn phải được sự chấp thuận hoặc cấp phép bằng văn bản của đơn vị chủ quản là Công ty TNHH Kỹ Thuật Thương Mại Thái Khương).</span>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div>
                        <span>Mặc dù Công ty TNHH Kỹ Thuật Thương Mại Thái Khương sử dụng các biện pháp cẩn trọng nhất để đảm bảo rằng những thông tin trên website thaikhuongpump.com là chính xác tại thời điểm công bố, nhưng chúng tôi không chịu bất kỳ trách nhiệm về tính chính xác, độ tin cậy và đầy đủ được đăng tải trên đó.</span>
                    </div>
                    <br/>
                    <div>
                ...
                <div>
                    ...
                    <div>
                        <span>Chúng tôi có toàn quyền thay đổi, chỉnh sửa hoặc bổ sung các chính sách này vào bất kỳ lúc nào để đáp ứng sự thay đổi của môi trường pháp lý, yêu cầu kinh doanh, hoặc đáp ứng nhu cầu của khách hàng hoặc sản phẩm của chúng tôi mà không cần phải thông báo trước.</span>
                    </div>
                </div>
            </div>
        );
